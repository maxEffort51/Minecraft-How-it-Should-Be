package net.maxeffort.beyond.block;

import net.maxeffort.helper.block.BlockSettings;
...
import net.maxeffort.beyond.block.custom.FluffBlock;
import net.maxeffort.beyond.block.custom.PurifierTableBlock;
...
public class ModBlocks extends HelperBlocks {
    public static Identifier id(String value) { return id(BeyondMod.id(), value); }
...
//    public static final Block SPRING_WATER = sortBlock(id("spring_water"), new FluidBlock(Fluids.WATER,BlockSettings.copy(Blocks.WATER).get()),ps_NORMAL).copy(BLIPNUM);
    ...
    public static void registerModBlocks() {
        BeyondMod.debug("Registering Mod Blocks for " + BeyondMod.id());
