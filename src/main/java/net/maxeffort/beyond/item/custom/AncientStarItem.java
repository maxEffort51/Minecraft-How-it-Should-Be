...
import net.maxeffort.helper.mob.EntityHelper;
...
public class AncientStarItem extends Item {
    private static final RegistryKey<DamageType> ANCIENT_STAR_REFLECT = RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.of(BeyondMod.id(), "ancient_star_reflect"));
