...
public class DoverTalentItem extends Item {
    private static final Identifier DAMAGE_BOOST_ID = Identifier.of(BeyondMod.id(), "dover_damage_boost");
    private static final Identifier ARMOR_BOOST_ID = Identifier.of(BeyondMod.id(), "dover_armor_boost");
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        BeyondMod.debug("Dover Talent Use Attempt");
    ...
    private static void redTickLogic(LivingEntity entity) {
        try {
            ...
            BeyondMod.debug("Dover Talent - Red Tick Error: " + e.getMessage());
        }
    }
    ...
    private void orangeTick(LivingEntity user, ServerWorld world) {
        try {
            ...
            BeyondMod.debug("Dover Talent - Orange Tick Error: " + e.getMessage());
        }
    }
    ...
    private void blueTick(LivingEntity user, ServerWorld world) {
        try {
            ...
            BeyondMod.debug("Dover Talent - Blue Tick Error: " + e.getMessage());
        }
    }
