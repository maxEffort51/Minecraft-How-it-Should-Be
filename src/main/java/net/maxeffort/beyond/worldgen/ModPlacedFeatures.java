...
import net.maxeffort.helper.worldgen.HelperPlacedFeatures;
...
public class ModPlacedFeatures extends HelperPlacedFeatures {
    protected static RegistryKey<PlacedFeature> key(String name) { return key(BeyondMod.id(), name); }
    protected static RegistryKey<PlacedFeature> ore(String name, RegistryKey<ConfiguredFeature<?, ?>> configKey, int perChunk, PlacementModifier... modifiers) {
        return ore(BeyondMod.id(), name, configKey, perChunk, modifiers);
    }
    ...
    public static void generate() {
        BeyondMod.debug("Generating Placed Features for beyond");
