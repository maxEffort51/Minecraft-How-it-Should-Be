...
// BLOCK ENTITY TYPE: public static final BlockEntityType<TableBlockEntity> PURIFIER_BLOCK_ENTITY = Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(HisbMod.id(), "purifier_be"),
