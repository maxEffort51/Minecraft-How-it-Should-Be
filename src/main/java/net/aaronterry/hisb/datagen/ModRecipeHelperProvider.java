...
public class ModRecipeHelperProvider extends FabricRecipeProvider {
    ...
    public static class Shaped {
        ...
        public static class Details {
            ...
            private ItemConvertible[] inputs;
            ...
            public Details needs(int i) { builder.criterion(hasItem(inputs[i]), conditionsFromItem(inputs[i])); return this; }
            public Details pattern(Pattern pattern) { pattern.with(builder); return this; }
            public Details input(char[] chars, ItemConvertible[] items) { inputs = items; for (int i = 0; i < chars.length; i++) builder.input(chars[i],items[i]); return this; }
            public Details input(char c, ItemConvertible item) { builder.input(c, item); return this; }
