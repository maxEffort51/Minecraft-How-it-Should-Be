...
public class ModArmorMaterials extends HelperArmorMaterials {
    ...
    public static final RegistryEntry<ArmorMaterial> UNTILLIUM = makeMaterial(id("untillium"), map(8,12,10,7,15), 25, 4.0f, 0.45f).repairWith(ingredient(ModItems.UNTILLIUM_BAR)).get();
}